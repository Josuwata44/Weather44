...
struct UstunomiyaView: View {
    ...
    VStack{
        ...
        }.onAppear(perform: viewModel.utsnomiya)
    }
}

struct UstunomiyaView_Previews: PreviewProvider {
    static var previews: some View {
        UstunomiyaView(viewModel: WeatherViewModel())
    }
}
